---
permalink: /2.1.0/nogroup/v1/externalSecret/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withRefreshPolicy(refreshPolicy)`](#fn-specwithrefreshpolicy)
  ...
  * [`obj spec.dataFrom`](#obj-specdatafrom)
    ...
    * [`obj spec.dataFrom.rewrite`](#obj-specdatafromrewrite)
      * [`obj spec.dataFrom.rewrite.merge`](#obj-specdatafromrewritemerge)
        * [`fn withConflictPolicy(conflictPolicy)`](#fn-specdatafromrewritemergewithconflictpolicy)
        * [`fn withInto(into)`](#fn-specdatafromrewritemergewithinto)
        * [`fn withPriority(priority)`](#fn-specdatafromrewritemergewithpriority)
        * [`fn withPriorityMixin(priority)`](#fn-specdatafromrewritemergewithprioritymixin)
        * [`fn withPriorityPolicy(priorityPolicy)`](#fn-specdatafromrewritemergewithprioritypolicy)
        * [`fn withStrategy(strategy)`](#fn-specdatafromrewritemergewithstrategy)
  ...
  * [`obj spec.target`](#obj-spectarget)
    ...
    * [`obj spec.target.manifest`](#obj-spectargetmanifest)
      * [`fn withApiVersion(apiVersion)`](#fn-spectargetmanifestwithapiversion)
      * [`fn withKind(kind)`](#fn-spectargetmanifestwithkind)
    * [`obj spec.target.template`](#obj-spectargettemplate)
      ...
      * [`obj spec.target.template.metadata`](#obj-spectargettemplatemetadata)
        ...
        * [`fn withFinalizers(finalizers)`](#fn-spectargettemplatemetadatawithfinalizers)
        * [`fn withFinalizersMixin(finalizers)`](#fn-spectargettemplatemetadatawithfinalizersmixin)
...
### fn spec.dataFrom.rewrite.merge.withInto
...
### fn spec.dataFrom.rewrite.merge.withPriority
...
### fn spec.dataFrom.rewrite.merge.withPriorityMixin
...
### fn spec.dataFrom.rewrite.merge.withPriorityPolicy
...
### fn spec.dataFrom.rewrite.merge.withStrategy
...
### fn spec.target.manifest.withApiVersion
...
### fn spec.target.manifest.withKind
...
### fn spec.target.template.metadata.withFinalizers
...
### fn spec.target.template.metadata.withFinalizersMixin
