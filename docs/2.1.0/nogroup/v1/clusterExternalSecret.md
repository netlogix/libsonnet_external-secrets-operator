---
permalink: /2.1.0/nogroup/v1/clusterExternalSecret/
---

# nogroup.v1.clusterExternalSecret
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.externalSecretSpec`](#obj-specexternalsecretspec)
    ...
    * [`fn withRefreshPolicy(refreshPolicy)`](#fn-specexternalsecretspecwithrefreshpolicy)
    ...
    * [`obj spec.externalSecretSpec.dataFrom`](#obj-specexternalsecretspecdatafrom)
      ...
      * [`obj spec.externalSecretSpec.dataFrom.rewrite`](#obj-specexternalsecretspecdatafromrewrite)
        * [`obj spec.externalSecretSpec.dataFrom.rewrite.merge`](#obj-specexternalsecretspecdatafromrewritemerge)
          * [`fn withConflictPolicy(conflictPolicy)`](#fn-specexternalsecretspecdatafromrewritemergewithconflictpolicy)
          * [`fn withInto(into)`](#fn-specexternalsecretspecdatafromrewritemergewithinto)
          * [`fn withPriority(priority)`](#fn-specexternalsecretspecdatafromrewritemergewithpriority)
          * [`fn withPriorityMixin(priority)`](#fn-specexternalsecretspecdatafromrewritemergewithprioritymixin)
          * [`fn withPriorityPolicy(priorityPolicy)`](#fn-specexternalsecretspecdatafromrewritemergewithprioritypolicy)
          * [`fn withStrategy(strategy)`](#fn-specexternalsecretspecdatafromrewritemergewithstrategy)
    ...
    * [`obj spec.externalSecretSpec.target`](#obj-specexternalsecretspectarget)
      ...
      * [`obj spec.externalSecretSpec.target.manifest`](#obj-specexternalsecretspectargetmanifest)
        * [`fn withApiVersion(apiVersion)`](#fn-specexternalsecretspectargetmanifestwithapiversion)
        * [`fn withKind(kind)`](#fn-specexternalsecretspectargetmanifestwithkind)
      * [`obj spec.externalSecretSpec.target.template`](#obj-specexternalsecretspectargettemplate)
        ...
        * [`obj spec.externalSecretSpec.target.template.metadata`](#obj-specexternalsecretspectargettemplatemetadata)
          ...
          * [`fn withFinalizers(finalizers)`](#fn-specexternalsecretspectargettemplatemetadatawithfinalizers)
          * [`fn withFinalizersMixin(finalizers)`](#fn-specexternalsecretspectargettemplatemetadatawithfinalizersmixin)
...
### fn spec.externalSecretSpec.withRefreshPolicy
...
## obj spec.externalSecretSpec.dataFrom.rewrite.merge

"Used to merge key/values in one single Secret\nThe resulting key will contain all values from the specified secrets"

### fn spec.externalSecretSpec.dataFrom.rewrite.merge.withConflictPolicy

```ts
withConflictPolicy(conflictPolicy)
```

"Used to define the policy to use in conflict resolution."

### fn spec.externalSecretSpec.dataFrom.rewrite.merge.withInto
...
### fn spec.externalSecretSpec.dataFrom.rewrite.merge.withPriority
...
### fn spec.externalSecretSpec.dataFrom.rewrite.merge.withPriorityMixin
...
### fn spec.externalSecretSpec.dataFrom.rewrite.merge.withPriorityPolicy
...
### fn spec.externalSecretSpec.dataFrom.rewrite.merge.withStrategy
...
## obj spec.externalSecretSpec.target.manifest
...
### fn spec.externalSecretSpec.target.manifest.withApiVersion
...
### fn spec.externalSecretSpec.target.manifest.withKind
...
### fn spec.externalSecretSpec.target.template.metadata.withFinalizers
...
### fn spec.externalSecretSpec.target.template.metadata.withFinalizersMixin
