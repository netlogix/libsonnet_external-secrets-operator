---
permalink: /2.1.0/generators/v1alpha1/gcrAccessToken/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.auth`](#obj-specauth)
    ...
    * [`obj spec.auth.workloadIdentityFederation`](#obj-specauthworkloadidentityfederation)
      * [`fn withAudience(audience)`](#fn-specauthworkloadidentityfederationwithaudience)
      * [`fn withExternalTokenEndpoint(externalTokenEndpoint)`](#fn-specauthworkloadidentityfederationwithexternaltokenendpoint)
      * [`obj spec.auth.workloadIdentityFederation.awsSecurityCredentials`](#obj-specauthworkloadidentityfederationawssecuritycredentials)
        * [`fn withRegion(region)`](#fn-specauthworkloadidentityfederationawssecuritycredentialswithregion)
        * [`obj spec.auth.workloadIdentityFederation.awsSecurityCredentials.awsCredentialsSecretRef`](#obj-specauthworkloadidentityfederationawssecuritycredentialsawscredentialssecretref)
          * [`fn withName(name)`](#fn-specauthworkloadidentityfederationawssecuritycredentialsawscredentialssecretrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specauthworkloadidentityfederationawssecuritycredentialsawscredentialssecretrefwithnamespace)
      * [`obj spec.auth.workloadIdentityFederation.credConfig`](#obj-specauthworkloadidentityfederationcredconfig)
        * [`fn withKey(key)`](#fn-specauthworkloadidentityfederationcredconfigwithkey)
        * [`fn withName(name)`](#fn-specauthworkloadidentityfederationcredconfigwithname)
        * [`fn withNamespace(namespace)`](#fn-specauthworkloadidentityfederationcredconfigwithnamespace)
      * [`obj spec.auth.workloadIdentityFederation.serviceAccountRef`](#obj-specauthworkloadidentityfederationserviceaccountref)
        * [`fn withAudiences(audiences)`](#fn-specauthworkloadidentityfederationserviceaccountrefwithaudiences)
        * [`fn withAudiencesMixin(audiences)`](#fn-specauthworkloadidentityfederationserviceaccountrefwithaudiencesmixin)
        * [`fn withName(name)`](#fn-specauthworkloadidentityfederationserviceaccountrefwithname)
        * [`fn withNamespace(namespace)`](#fn-specauthworkloadidentityfederationserviceaccountrefwithnamespace)
...
### fn spec.auth.workloadIdentityFederation.withExternalTokenEndpoint
...
## obj spec.auth.workloadIdentityFederation.awsSecurityCredentials
...
### fn spec.auth.workloadIdentityFederation.awsSecurityCredentials.withRegion
...
## obj spec.auth.workloadIdentityFederation.awsSecurityCredentials.awsCredentialsSecretRef
...
### fn spec.auth.workloadIdentityFederation.awsSecurityCredentials.awsCredentialsSecretRef.withName
...
### fn spec.auth.workloadIdentityFederation.awsSecurityCredentials.awsCredentialsSecretRef.withNamespace
...
## obj spec.auth.workloadIdentityFederation.credConfig
...
### fn spec.auth.workloadIdentityFederation.credConfig.withKey
...
### fn spec.auth.workloadIdentityFederation.credConfig.withName
...
### fn spec.auth.workloadIdentityFederation.credConfig.withNamespace
...
## obj spec.auth.workloadIdentityFederation.serviceAccountRef
...
### fn spec.auth.workloadIdentityFederation.serviceAccountRef.withAudiences
...
### fn spec.auth.workloadIdentityFederation.serviceAccountRef.withAudiencesMixin
...
### fn spec.auth.workloadIdentityFederation.serviceAccountRef.withName
...
### fn spec.auth.workloadIdentityFederation.serviceAccountRef.withNamespace
