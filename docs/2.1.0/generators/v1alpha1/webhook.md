---
permalink: /2.1.0/generators/v1alpha1/webhook/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.auth`](#obj-specauth)
    * [`obj spec.auth.ntlm`](#obj-specauthntlm)
      * [`obj spec.auth.ntlm.passwordSecret`](#obj-specauthntlmpasswordsecret)
        * [`fn withKey(key)`](#fn-specauthntlmpasswordsecretwithkey)
        * [`fn withName(name)`](#fn-specauthntlmpasswordsecretwithname)
        * [`fn withNamespace(namespace)`](#fn-specauthntlmpasswordsecretwithnamespace)
      * [`obj spec.auth.ntlm.usernameSecret`](#obj-specauthntlmusernamesecret)
        * [`fn withKey(key)`](#fn-specauthntlmusernamesecretwithkey)
        * [`fn withName(name)`](#fn-specauthntlmusernamesecretwithname)
        * [`fn withNamespace(namespace)`](#fn-specauthntlmusernamesecretwithnamespace)
...
## obj spec.auth.ntlm.passwordSecret

"SecretKeySelector is a reference to a specific 'key' within a Secret resource.\nIn some instances, `key` is a required field."

### fn spec.auth.ntlm.passwordSecret.withKey
...
### fn spec.auth.ntlm.passwordSecret.withName
...
### fn spec.auth.ntlm.passwordSecret.withNamespace
...
## obj spec.auth.ntlm.usernameSecret

"SecretKeySelector is a reference to a specific 'key' within a Secret resource.\nIn some instances, `key` is a required field."

### fn spec.auth.ntlm.usernameSecret.withKey
...
### fn spec.auth.ntlm.usernameSecret.withName
...
### fn spec.auth.ntlm.usernameSecret.withNamespace
