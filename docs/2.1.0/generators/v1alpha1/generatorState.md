---
permalink: /2.1.0/generators/v1alpha1/generatorState/
---

# generators.v1alpha1.generatorState
...
* [`obj spec`](#obj-spec)
  * [`fn withGarbageCollectionDeadline(garbageCollectionDeadline)`](#fn-specwithgarbagecollectiondeadline)
...
new returns an instance of GeneratorState
...
### fn spec.withGarbageCollectionDeadline

```ts
withGarbageCollectionDeadline(garbageCollectionDeadline)
```
