---
permalink: /2.1.0/generators/v1alpha1/vaultDynamicSecret/
---
  ...
  * [`obj spec.provider`](#obj-specprovider)
    ...
    * [`obj spec.provider.auth`](#obj-specproviderauth)
      ...
      * [`obj spec.provider.auth.cert`](#obj-specproviderauthcert)
        * [`fn withPath(path)`](#fn-specproviderauthcertwithpath)
      ...
      * [`obj spec.provider.auth.gcp`](#obj-specproviderauthgcp)
        * [`fn withLocation(location)`](#fn-specproviderauthgcpwithlocation)
        * [`fn withPath(path)`](#fn-specproviderauthgcpwithpath)
        * [`fn withProjectID(projectID)`](#fn-specproviderauthgcpwithprojectid)
        * [`fn withRole(role)`](#fn-specproviderauthgcpwithrole)
        * [`obj spec.provider.auth.gcp.secretRef`](#obj-specproviderauthgcpsecretref)
          * [`obj spec.provider.auth.gcp.secretRef.secretAccessKeySecretRef`](#obj-specproviderauthgcpsecretrefsecretaccesskeysecretref)
            * [`fn withKey(key)`](#fn-specproviderauthgcpsecretrefsecretaccesskeysecretrefwithkey)
            * [`fn withName(name)`](#fn-specproviderauthgcpsecretrefsecretaccesskeysecretrefwithname)
            * [`fn withNamespace(namespace)`](#fn-specproviderauthgcpsecretrefsecretaccesskeysecretrefwithnamespace)
        * [`obj spec.provider.auth.gcp.serviceAccountRef`](#obj-specproviderauthgcpserviceaccountref)
          * [`fn withAudiences(audiences)`](#fn-specproviderauthgcpserviceaccountrefwithaudiences)
          * [`fn withAudiencesMixin(audiences)`](#fn-specproviderauthgcpserviceaccountrefwithaudiencesmixin)
          * [`fn withName(name)`](#fn-specproviderauthgcpserviceaccountrefwithname)
          * [`fn withNamespace(namespace)`](#fn-specproviderauthgcpserviceaccountrefwithnamespace)
        * [`obj spec.provider.auth.gcp.workloadIdentity`](#obj-specproviderauthgcpworkloadidentity)
          * [`fn withClusterLocation(clusterLocation)`](#fn-specproviderauthgcpworkloadidentitywithclusterlocation)
          * [`fn withClusterName(clusterName)`](#fn-specproviderauthgcpworkloadidentitywithclustername)
          * [`fn withClusterProjectID(clusterProjectID)`](#fn-specproviderauthgcpworkloadidentitywithclusterprojectid)
          * [`obj spec.provider.auth.gcp.workloadIdentity.serviceAccountRef`](#obj-specproviderauthgcpworkloadidentityserviceaccountref)
            * [`fn withAudiences(audiences)`](#fn-specproviderauthgcpworkloadidentityserviceaccountrefwithaudiences)
            * [`fn withAudiencesMixin(audiences)`](#fn-specproviderauthgcpworkloadidentityserviceaccountrefwithaudiencesmixin)
            * [`fn withName(name)`](#fn-specproviderauthgcpworkloadidentityserviceaccountrefwithname)
            * [`fn withNamespace(namespace)`](#fn-specproviderauthgcpworkloadidentityserviceaccountrefwithnamespace)
    ...
    * [`obj spec.provider.checkAndSet`](#obj-specprovidercheckandset)
      * [`fn withRequired(required)`](#fn-specprovidercheckandsetwithrequired)
...
### fn spec.provider.auth.cert.withPath
...
### fn spec.provider.auth.gcp.withPath
...
### fn spec.provider.auth.gcp.withProjectID
...
### fn spec.provider.auth.gcp.withRole
...
## obj spec.provider.auth.gcp.secretRef

"Specify credentials in a Secret object"

## obj spec.provider.auth.gcp.secretRef.secretAccessKeySecretRef

"The SecretAccessKey is used for authentication"

### fn spec.provider.auth.gcp.secretRef.secretAccessKeySecretRef.withKey
...
### fn spec.provider.auth.gcp.secretRef.secretAccessKeySecretRef.withName
...
### fn spec.provider.auth.gcp.secretRef.secretAccessKeySecretRef.withNamespace
...
## obj spec.provider.auth.gcp.serviceAccountRef

"ServiceAccountRef to a service account for impersonation"

### fn spec.provider.auth.gcp.serviceAccountRef.withAudiences
...
### fn spec.provider.auth.gcp.serviceAccountRef.withAudiencesMixin
...
### fn spec.provider.auth.gcp.serviceAccountRef.withName
...
### fn spec.provider.auth.gcp.serviceAccountRef.withNamespace
...
## obj spec.provider.auth.gcp.workloadIdentity

"Specify a service account with Workload Identity"

### fn spec.provider.auth.gcp.workloadIdentity.withClusterLocation
...
### fn spec.provider.auth.gcp.workloadIdentity.withClusterName
...
### fn spec.provider.auth.gcp.workloadIdentity.withClusterProjectID
...
## obj spec.provider.auth.gcp.workloadIdentity.serviceAccountRef

"ServiceAccountSelector is a reference to a ServiceAccount resource."

### fn spec.provider.auth.gcp.workloadIdentity.serviceAccountRef.withAudiences
...
### fn spec.provider.auth.gcp.workloadIdentity.serviceAccountRef.withAudiencesMixin
...
### fn spec.provider.auth.gcp.workloadIdentity.serviceAccountRef.withName
...
### fn spec.provider.auth.gcp.workloadIdentity.serviceAccountRef.withNamespace
...
### fn spec.provider.checkAndSet.withRequired
